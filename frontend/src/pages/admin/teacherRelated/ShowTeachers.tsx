...
import { StyledTableCell, StyledTableRow } from '../../../components/Styles.tsx';
import { BlueButton, GreenButton } from '../../../components/ButtonStyles.tsx';
    ...
    if (loading) {
        ...
        return (
            <Box sx={{ display: 'flex', justifyContent: 'flex-end', marginTop: '16px' }}>
                <GreenButton variant="contained" onClick={() => navigate("/Admin/teachers/Classes.tsx")}>
                    Add Teacher
                </GreenButton>
            </Box>
        );
